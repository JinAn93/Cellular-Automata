 ...
 * Cell updates according to the specific rules defined by the LangtonsLoop simulation.
 * 
...
public class LangtonsLoopRules extends SimulationRules {
    private static final int paramNeeded = 0;
    public static final int DEAD = 1;
    public static final int ALIVE = 2;

    public LangtonsLoopRules () {
        super();
    }
